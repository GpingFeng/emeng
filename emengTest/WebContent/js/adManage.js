...
$(function () {
    layui.use(['laypage','layer','form'], function() {
        ...
        //ajax获取总页数
        $.ajax({
            url: 'http://localhost:8080/emeng/adverPage',//请求的url地址
        ...
        function adverEdit() {
            ...
            layer.open({
                ...
                success:function () {
                    $.ajax({
                        url: "http://localhost:8080/emeng/adverselectByPK",    //请求的url地址
                        dataType: "json",   //返回格式为json
                        async: true, //请求是否异步，默认为异步，这也是ajax重要特性
                        data: {'id':id},    //参数值
                        type: "POST",
                        success:  function(data) {
                            ...
                            $("#layui-layer-iframe1").contents().find("#adInfoform").on('submit',function (e) {
                                ...
                                console.log("zhende");
                                $.ajax({
                                    url: "http://localhost:8080/emeng/adverupdateByPK",    //请求的url地址
                                    dataType: "json",  //返回格式为json
                                    async: true, //请求是否异步，默认为异步，这也是ajax重要特性
                                    // {"id":30,"name":"30","pic":"30","link":"30","lesson":0,"chapter":0}
                                    data :{"id":id,"slogan":afterSlogan,"link":afterLink,"picpic":afterPic,"pageNum":1,"pageSize":10},
                                    type: "POST",   //请求方式
                                    success: function() {
            ...
            layer.open({
                ...
                success:function () {
                    $("#layui-layer-iframe1").contents().find("#adInfoform").on('submit',function (e) {
                                ...
                                //把投稿数据传到后台
                                $.ajax({
                                    url: "http://localhost:8080/emeng/adverinsert",    //请求的url地址
                                    dataType: "json",  //返回格式为json
                                    async: true, //请求是否异步，默认为异步，这也是ajax重要特性
                                    // {"id":30,"name":"30","pic":"30","link":"30","lesson":0,"chapter":0}
                                    data :{"slogan":afterSlogan,"link":afterLink,"picpic":afterPic},
                                    type: "POST",   //请求方式
                                    success: function() {
                                        // layer.close(layer.index);//先关闭当前窗口
                                        //请求成功处理
        ...
        function adverDelete() {
            ...
            layer.confirm('确认要删除吗？',function(index){
                ...
                //捉到被选中的，发异步进行删除
                $.ajax({
                    url: "http://localhost:8080/emeng/adverdelPK",    //请求的url地址
                    dataType: "json",   //返回格式为json
                    async: true, //请求是否异步，默认为异步，这也是ajax重要特性
